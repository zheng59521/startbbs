<?php /*a:2:{s:36:"./themes/default/category/topic.html";i:1521208325;s:33:"./themes/default/common/base.html";i:1533707407;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="layui-row layui-col-space15">
    <div class="layui-col-md8">
      <div class="fly-panel" style="margin-bottom: 0;">
        ...
        <ul class="fly-list">          
		<?php if(is_array($topiclist) || $topiclist instanceof \think\Collection || $topiclist instanceof \think\Paginator): $i = 0; $__LIST__ = $topiclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <li>
    ...
    <div class="layui-col-md4">
      <div class="fly-panel fly-link">
        <h3 class="fly-panel-title">关于 <?php echo htmlentities($category['name']); ?></h3>
        <dl class="fly-panel-main">
	        <p><img style="width:100px;height:100px;" src="<?php echo htmlentities($category['thumb']); ?>" alt="<?php echo htmlentities($category['name']); ?>"></p>
	        <p><?php echo htmlentities($category['description']); ?></p>
        </dl>
      </div>
      <dl class="fly-panel fly-list-one">
        <dt class="fly-panel-title">本版热议</dt>
        <?php if(is_array($hottopic) || $hottopic instanceof \think\Collection || $hottopic instanceof \think\Paginator): $i = 0; $__LIST__ = $hottopic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <dd>
          <a href="<?php echo url('topic/detail',['id'=>$vo['id']]); ?>"><?php echo htmlentities($vo['title']); ?></a>
