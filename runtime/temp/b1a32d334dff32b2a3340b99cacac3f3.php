<?php /*a:2:{s:34:"./themes/admin/category/index.html";i:1521208325;s:24:"./themes/admin/base.html";i:1521208325;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i<$vo['level'];$i++){echo ' ----';} endif; ?> <?php echo htmlentities($vo['name']); ?></td>
                        <td>
                            <a href="<?php echo url('admin/category/add',['pid'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini">添加子版块</a>
