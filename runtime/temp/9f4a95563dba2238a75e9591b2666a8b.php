<?php /*a:1:{s:31:"./themes/admin/login/index.html";i:1521208325;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <!--[if lt IE 9]>
    <script src="/bbs/public/static/common/js/html5shiv.min.js"></script>
    <script src="/bbs/public/static/common/js/respond.min.js"></script>
    <style>
...
<body class="login">
<div class="login-title">StartBBS后台管理</div>
