<?php /*a:2:{s:33:"./themes/admin/category/edit.html";i:1521208325;s:24:"./themes/admin/base.html";i:1521208325;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/category/index'); ?>">版块管理</a></li>
            <li class=""><a href="<?php echo url('admin/category/add'); ?>">添加版块</a></li>
            ...
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/category/update'); ?>" method="post">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="pid" lay-verify="required">
                                ...
                                <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($category['id']==$vo['id']): ?> disabled="disabled"<?php endif; if($category['pid']==$vo['id']): ?> selected="selected"<?php endif; ?>><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i<$vo['level'];$i++){echo ' ----';} endif; ?> <?php echo htmlentities($vo['name']); ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" value="<?php echo htmlentities($category['name']); ?>" required  lay-verify="required" placeholder="请输入版块名称" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">别名</label>
                        <div class="layui-input-block">
                            <input type="text" name="alias" value="<?php echo htmlentities($category['alias']); ?>" placeholder="（选填）请输入版块别名" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">图标</label>
                        <div class="layui-input-block">
                            <input type="text" name="icon" value="<?php echo htmlentities($category['icon']); ?>" placeholder="（选填）如：fa fa-home" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">缩略图</label>
                        <div class="layui-input-block">
                            <input type="text" name="thumb" value="<?php echo htmlentities($category['thumb']); ?>" class="layui-input layui-input-inline" id="thumb">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="description" class="layui-textarea" id="description"><?php echo htmlentities($category['description']); ?></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="sort" value="<?php echo htmlentities($category['sort']); ?>" required  lay-verify="required" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">列表模板</label>
                        <div class="layui-input-block">
                            <input type="text" name="list_template" value="<?php echo htmlentities($category['list_template']); ?>" placeholder="（选填）请输入模板文件名" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">详情模板</label>
                        <div class="layui-input-block">
                            <input type="text" name="detail_template" value="<?php echo htmlentities($category['detail_template']); ?>" placeholder="（选填）请输入模板文件名" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
...
upload.render({
    ...
    ext: 'jpg|png|gif|bmp',
    size:10240,
	data:{cid:<?php echo htmlentities($category['id']); ?>},
    done: function(res){
	    //如果上传失败
        if(res.error == 1){
